...
PAYMENT_FAILURE_DIAGNOSES = {
    ...
    "payment_method_degraded": {
        ...
        "reason": "The customer historically succeeds more often than the current payment method."
    },
    "gateway_error": {
...
def apply_scenario_recovery_policy(
    ...
    #
    # IMPORTANT:
    # Preserve the specific diagnosis produced by the agent.
    #
    # Example:
    #
    # Agent:
    ...
    # payment_failure
    #
    # The API must NOT overwrite bank_decline with
    # payment_failure.
    # ========================================================
    ...
    # - channel
    #
    # It does NOT control the diagnosis.
    # ========================================================
...
policy[
    ...
    # Agent reports whether one recovery attempt
    # should be counted.
    execution[
        "attempt_increment"
    ] = 1
...
def run_recovery_agent(
    ...
    # IMPORTANT:
    # Give the agent its own transaction dictionary.
    # This prevents RecoveryAgent from mutating the API-owned
    # transaction state, especially recovery_attempts.
...
async def process_recovery_event(
    ...
    try:
        ...
        # Finalize bounded escalation using the server-owned count.
        if not bool(execution.get("recovered", False)):
            if transaction["recovery_attempts"] >= MAX_RECOVERY_ATTEMPTS:
                result["stopping"] = {
                    "stop": True,
                ...
                result["escalation"] = {
                    ...
                    "reason": "maximum_automated_recovery_attempts_reached",
